...
BOT_TOKEN = os.getenv("BOT_TOKEN") LOG_CHANNEL_ID = -1002699774923  # Replace with your channel ID YTS_API = "https://yts.mx/api/v2/list_movies.json?query_term={}"
...
if user_id not in LOGGED_USERS:
    ...
    await context.bot.send_message(chat_id=LOG_CHANNEL_ID, text=user_info)
